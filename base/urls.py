...
urlpatterns = [
    ...
    path("settings/microsoft-fetch-org/", views.microsoft_fetch_org, name="microsoft-fetch-org"),
    path("settings/microsoft-confirm-company/", views.microsoft_confirm_company, name="microsoft-confirm-company"),
    path("settings/microsoft-fetch-users/", views.microsoft_fetch_users, name="microsoft-fetch-users"),
    path("settings/microsoft-sync-properties/", views.microsoft_sync_properties, name="microsoft-sync-properties"),
    path("settings/microsoft-test-connection/", views.microsoft_test_connection, name="microsoft-test-connection"),
    path("settings/microsoft-test-mail/", views.microsoft_test_mail, name="microsoft-test-mail"),
